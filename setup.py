...
def main():
    ...
    metadata = dict(
        ...
        package_data = {'onix':['data/default_libs/*', 'data/other_libs/argonne/*', 'data/other_libs/ENDFVIII/*','data/other_libs/jeff33/*','data/other_libs/origen2.2/*','data/isomeric_data/eaf-2010-multiplicities/*']}
